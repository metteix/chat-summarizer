...
class ItemAnalysis(BaseModel):
    ...
    about: str = Field(description="Краткая выжимка на русском. Для ссылок - заголовок, для задач - действие + дедлайн(если указан), для хештегов - важные хештеги, для упоминаний - важные упоминания, для документов - заголовки.")
...
PROMPTS = {
    ...
    Поле 'about': Напиши, что это за ресурс, исходя из URL и комментария пользователя. Пример: "Лекция по Алгосам (YouTube)".
    """,
    ...
    Поле 'about': Объедини имя файла и контекст. Пример: "Презентация к лекции 5".
    """,
    ...
    Поле 'about': Четко сформулируй задачу. Если есть дата/время — обязательно укажи. Пример: "Сдать лабу до вторника (12:00)".
    """,
    ...
    - Если контекста НЕТ (или он дублирует тег), просто напиши категорию. 
      Пример: Для тега #расписание напиши "Материалы по расписанию". Для тега #матан напиши "Материалы по матанализу".
    """,
